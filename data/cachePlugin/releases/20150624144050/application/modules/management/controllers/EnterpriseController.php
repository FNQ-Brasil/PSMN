...
class Management_EnterpriseController extends Vtx_Action_Abstract {
    ...
    public function indexAction() {
        ...
        if ($this->showAppraisersFilter) {
            ...
            $this->view->getAllAppraisers = $this->dbTableUser->getAllAppraiserByRegionalServiceArea(null, $regionalId);
        }
        ...
        $this->view->getAllEnterprise = $this->Enterprise->getAllByColAE(
                $this->paramsBuscaServiceArea[0], $this->paramsBuscaServiceArea[1], $this->autoavaliacaoId, $count, $page, $filter, $orderBy, $format, $fetchReturn, $this->tipoRelatorio
        );
    }
    ...
    public function reportRegionalAction() {
        ...
        $queryRegionaisBairro = $this->view->getAllEnterprise;
        $queryRegionaisCidade = $this->Enterprise->getAllByColAE(
                $this->paramsBuscaServiceArea[0], $this->paramsBuscaServiceArea[1], $this->autoavaliacaoId, 
                null, null, $this->filter, null, $format, 'select', 'report-regional-cidades'
        );
        $this->view->dataReport = $this->Enterprise->getDataUnionReportRegionalQuerys(
                array($queryRegionaisBairro, $queryRegionaisCidade)
        );
    }
    ...
    public function doClassificarFinalistaAction() {
        ...
        switch ($this->_getParam('posicao')) {
            case 1:
                $data['classificado_ouro'] = $check;
                break;
            case 2:
                $data['classificado_prata'] = $check;
                break;
            case 3:
                $data['classificado_bronze'] = $check;
                break;
        }
